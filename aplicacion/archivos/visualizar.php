...
$consulta = "select a.id_archivos,a.docente,a.size,a.nom_archivos,a.tipo_documento,a.ruta,a.extension,c.id_carrera,c.docente,c.clases,c.nombre_c from archivos a, carreras c where c.docente = '$rfc' and a.docente = '$rfc' and a.tipo_documento='planeaciones'";
...
<br>
  ...
  <table class="tabla-planeaciones"align=center border=1>
    <tr>
      <td class="categorias">Carrera</td>
